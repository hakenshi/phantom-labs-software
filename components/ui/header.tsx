...
export default function Header() {
    return (
        <header className="p-6 rounded-full border-gray-800 border bg-black/10  backdrop-blur-2xl w-[98%] mx-auto fixed z-50 top-5 left-1/2 transform -translate-x-1/2 font-bold">
            <nav className="flex justify-between items-center h-full">
                ...
                <div className="flex gap-5">
                    ...
                    <Link className="text-lg hover:scale-105 transition-transform ease-in duration-100" href={"/"}>Mission</Link>
